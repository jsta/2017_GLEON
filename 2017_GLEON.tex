...
\author{Joseph Stachelek, Patricia A. Soranno} % Author(s)
...
% "#00BA38" "#619CFF"
% \definecolor{lakestream}{"ForestGreen"}
% \definecolor{lakestream}{HTML}{00BA38}
\definecolor{stream}{HTML}{619CFF}

\begin{column}{0.3\textwidth}
\centering
\large Headwater \\
\vspace{0.5em}
\headwaterprofileflatequal[1.1]{red!80} \\
...
\large Stream \\
\vspace{0.5em}
\primaryprofileflatequal[1.1]{stream!80} \\
\textbf{ }
\end{column}
...
\large Lakestream \\
\vspace{0.5em}
\secondaryprofileflatequal[1.1]{green!100!black!80} \\
...
\begin{figure}
  \includegraphics[width=30cm]{gleon_poster_1.pdf}
\end{figure}
...
\begin{figure}
  \includegraphics[width=30cm]{gleon_poster_2.pdf}
\end{figure}
...
\begin{tabular}{ll}
\includegraphics[width=5cm]{nsf2.pdf} & \small Funding provided by NSF \#1517823. CNH-L: Linking Land-Use Decision Making, \\
