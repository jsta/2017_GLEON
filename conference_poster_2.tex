...
\begin{itemize}
\item Lakes were sampled on a monthyl basis for a one year period in one of 197*, 197*, 197*, or 197*.
\item Retention time was computed on the basis of concurrent USGS gage measurements normalized to estimate a mean flow for each month.
\item P retention was computed using a modification of the Vollenweider equations.
\begin{itemize}
