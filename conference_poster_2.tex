...
\begin{figure}
\includegraphics[width=0.8\linewidth]{conny_framework.png}
\caption{Figure caption}
\end{figure}

\begin{enumerate} \Large 
\item \textbf{In lakes with equal residence times, do higher connectivity lakes retain less phosphorus than lower connectivity lakes?}
...
\begin{itemize}
\item Web: \href{http://jsta.github.io}{http://jsta.github.io}
