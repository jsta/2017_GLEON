...
\large Given evidence that P retention in streams is affected by network connectivity:
...
\begin{block}{Results}
\begin{figure}
  \includegraphics[width=25cm, height=20cm]{p_retention_boxplot.pdf}
\end{figure}

\begin{figure}
  \includegraphics[width=30cm, height=20cm]{nls_coefs.pdf}
\end{figure}
